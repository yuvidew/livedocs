...
import { Comments } from '@/app/(root)/documents/[id]/_components/Comments';
...
function Placeholder() {
  return <div className="editor-placeholder text-white border-white">Enter some rich text...</div>;
}
